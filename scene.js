            ...
            let sprite = new THREE.TextureLoader().load('whiteC.jpg')
            let starMaterial = new THREE.PointsMaterial({
                color: 0xaaaaaa, size: 0.5 , map: sprite
            })
    // **********************************************************************
            ...
            meshX = -10
            for (i = 0; i<2000; i++){
                star = new THREE.Vector3( Math.random() * 800 - 400 , Math.random() * 800 - 400, Math.random() * 800 - 400 );
